package com.ustasoft.belajar.angularjs.json.jquery;
...
public class CustomUserDetailResponse {
	...
	public CustomUserDetailResponse() {
	}
	...
	public List<UserDetail> getRows() {
		return rows;
	}

	public void setRows(List<UserDetail> rows) {
		this.rows = rows;
	}
