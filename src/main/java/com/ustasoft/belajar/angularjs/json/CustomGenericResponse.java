package com.ustasoft.belajar.angularjs.json;
 ...
 * <p>We can use this to send generic messages to our JqGrid, whether a request
 * is successful or not. Of course, you will use plain JavaScript to parse the
 * JSON response.
 */
